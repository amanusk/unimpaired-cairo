...
// OpenZeppelin Contracts for Cairo v0.19.0 (account/utils/signature.cairo)

use core::ecdsa::check_ecdsa_signature;
use crate::comp_account::interface::{EthPublicKey, P256PublicKey};
...
fn is_valid_secp256_signature<
    Secp256Point, +Secp256Trait<Secp256Point>, +Secp256PointTrait<Secp256Point>, +Drop<Secp256Point>
>(
